...
회원가입 시 optional nickname은 Supabase Auth `user_metadata.nickname`에 먼저 저장되고, 로그인 후 `user_settings.nickname` 초기값으로 동기화됩니다. 이메일 인증이 켜져 있으면 사용자는 인증 메일을 승인한 뒤 로그인해야 합니다.
